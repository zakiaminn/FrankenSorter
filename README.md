...
**a local ai file sorter that reads your documents and files them away, all on your own machine**
...
* an "undo last sort" that keeps a small json history log and reverses it
