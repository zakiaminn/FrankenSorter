...
![Ollama](https://img.shields.io/badge/Local_AI-Ollama_Llama_3.2-black?style=for-the-badge)
...
* **100% Local Inference:** Utilizes Ollama to run Meta's Llama 3.2 model entirely on-device, ensuring zero API rate limits, zero subscription costs, and total data privacy.
...
* **Non-Deterministic JSON Post-Processing:** Uses Regex stripping to bypass LLM "hallucinations" and conversational fluff, guaranteeing valid JSON parameter extraction for file system operations.
...
2. **Analysis:** Text is fed to Llama 3.2 with strict system prompts requesting categorization (School, Work, Personal, Finance) and subject generation.
